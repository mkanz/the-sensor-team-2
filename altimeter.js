...
function postWeather(data) {
   ...
   var urlBase = 'http://14.139.34.32:8080/input/' + public_key + '?private_key=' +  private_key + "&altitude=%s&temp=%s&humidity=%s" ;
        var url = util.format(urlBase, mplData.altitude + " meters", mplData.temp+" C",'0');
